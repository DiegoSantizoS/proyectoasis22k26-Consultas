namespace CapaVista_Consultas.Controles
{
    partial class UcAgregarCondicion
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ConsultasTlpPrincipal.Controls.Add(this.ConsultasLblOrdenamiento, 0, 3);
            this.ConsultasTlpPrincipal.Controls.Add(this.ConsultasTlpOrdenamiento, 1, 3);
            this.ConsultasTlpPrincipal.Controls.Add(this.ConsultasLblCampo, 0, 0);
            this.ConsultasTlpPrincipal.Controls.Add(this.ConsultasCboOperadorCampo, 1, 0);
